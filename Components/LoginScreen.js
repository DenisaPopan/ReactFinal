...
class LoginScreen extends Component<Props> {
    ...
    handleLogin = () => {
        ...
        fetch("http://192.168.43.190:8080/users", {
            method: 'POST',
            headers: {
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                >
                    <DialogContent>
                        <Text style={styles.textPopUp2}> {"Date invalide! Introdu din nou datele! :)"}</Text>
                    </DialogContent>
                </Dialog>
                <Text style={styles.welcome}>Aplicatie React</Text>
