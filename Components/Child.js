...
class Child extends Component<Props> {
    ...
    componentWillMount() {
        ...
        const isAvailable = () => {
            ...
            const request = fetch('http://192.168.43.190:8080/tasks', {method: 'POST',
                headers: {
    ...
    update = (idx) => () => {
        ...
        fetch("http://192.168.43.190:8080/tasks", {
            method: 'PUT',
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
    ...
    render() {
        return (
            <View style={styles.container} key={1}>
                ...
                >
                    <DialogContent>
                        <Text style={styles.textPopUp}> {"Task-ul a fost updatat"}</Text>
                    </DialogContent>
                </Dialog>
